...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-md-6 col-xs-6 col-lg-6" id="log">
            <ul class="nav nav-tabs">
                <li class="nav-item" id="login">
                    <a class="nav-link active" aria-current="page" href="5_login.jsp">登录</a>
                </li>
            ...
            <form action="login-servlet">
                ...
                <button type="button" class="btn btn-primary" onclick="location.href='../admin_html/0_ad_login.jsp'">管理员登录</button>
                </div>
            </form>
        </div>
    </div>
