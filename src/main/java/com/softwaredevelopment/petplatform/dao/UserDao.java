...
public class UserDao {
    ...
    public static void insertUser(@NotNull User user)  {
        ...
        try {
            ...
            Object[] params = {user.getAccountNumber(), user.getUsername(), user.getPassword(),
    ...
    public static void deleteUser(@NotNull User user) {
        try {
            ...
            qr.update(sql, user.getAccountNumber());
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    ...
    public static void getUserByAccountNumber(int accountNumber) {
        ...
        QueryRunner qr = new QueryRunner(JDBCUtils.getDataSource());
        try {
            User u = qr.query(sql, new BeanHandler<User>(User.class), accountNumber);
